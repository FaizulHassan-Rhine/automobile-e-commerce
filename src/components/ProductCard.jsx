...
export default function ProductCard({ product }) {
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow duration-300 flex flex-col h-full group">
            <div className="relative h-48 w-full mb-4 flex items-center justify-center bg-gray-50 rounded overflow-hidden">
                {/* Product Image */}
                {product.image ? (
                    <img
                        src={product.image}
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="bg-orange-100 text-orange-600 hover:bg-orange-500 hover:text-white p-2 rounded-full transition-colors duration-300"
                    >
